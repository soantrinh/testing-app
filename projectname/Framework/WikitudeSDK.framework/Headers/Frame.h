...
namespace wikitude { namespace sdk {
    ...
    namespace impl {
        ...
        class Frame {
        public:
            Frame(unsigned char* frameData_, int frameDataSize_, Size<int> const size_, float scaledWidth_, float scaledHeight_, std::int64_t presentationTimestampValue_, std::int32_t presentationTimestampTimescale_);
            virtual ~Frame();
